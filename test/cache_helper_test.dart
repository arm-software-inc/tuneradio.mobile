...
import 'package:tune_radio/app/helpers/http_cached_helper.dart';
...
void main() {
  ...
  test("get httpcached", () async {
    final http =
        HttpCached(CacheHelper(CacheOptions(const Duration(seconds: 20))));
    final response = await http.get(Uri.parse(
        "http://all.api.radio-browser.info/json/stations/topclick?limit=20&hidebroken=true"));
